...
test("average", function() {
  ...
  equal(_.average([1,2,[3]], function(n) { return n * 2; }, true), 4, 'the average value of an array with deep members was computed while applied to a callback function');
});
...
test("max", function() {
  ...
  equal(_.max([1, 2, 3], function(n) { return n * 2; }), 6, 'returned max value from array whos values have been applied to a callback function');
});
...
test("min", function() {
  ...
  equal(_.min([1, 2, 3], function(n) { return n * 2; }), 2, 'returned min value from array whos values have been applied to a callback function');
});
...
test("sortBy", function() {
  ...
  deepEqual(_.sortBy([{foo: {bar: 2}}, {foo: {bar: 1}}, {foo: {bar: 3}}], 'foo.bar'), [{foo: {bar: 1}}, {foo: {bar: 2}}, {foo: {bar: 3}}], 'successfully sorted an array of object-literals by a deep property');
});
